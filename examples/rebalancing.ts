...
//     --wallet.accounts=0xe94000d730b9655850afc8e39facb7058678f11e765075d4806d27ed619f258c,2000000000000000000
...
const allChainWallets: WalletManagerConfig = {
  ethereum: {
    ...
    rebalance: {
      enabled: true,
      strategy: 'fillFromMax',
      interval: 10000,
      minBalanceThreshold: 0.3,
    },
    wallets: [
      {
        address: "0xFa6E597ca1c7E72838c850d1268dDf618D444712",
        tokens: []
      },
      {
        address: "0x084955aC084cBa93C8fccd997916b942DD3169B0",
        tokens: []
      },
      {
        address: "0x52E636aAC22CfDF8f79bBb9e9B4B87824cB532Ae",
        tokens: []
      },
      {
        address: "0x4d41A26fd00BB04564E04a16620a6B772D6aEdec",
        tokens: []
      },
      {
        address: "0x5d075F411a533d9134Fa5d4EBE0418584813B2a5",
        tokens: []
      },
      {
        address: "0x77a987b709dC03297cb4f2835C130C477836760b",
        tokens: []
      },
      {
        address: "0x12188a7270497b9f80Fe3CAB2eAf280F24b85066",
        tokens: []
      },
      {
        address: "0x801c5eA9B1A1bD287F487b516c0CAADe06AF10f1",
        tokens: []
      },
      {
        address: "0xEc18A727a11A65b71De926c7f5f39c56f42641E0",
        tokens: []
      },
      {
        address: "0x0EaC31cB932229D0Dcc628f89894012b7827481c",
        tokens: []
      }
    ]
  }
