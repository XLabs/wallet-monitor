import { WalletBalancesByAddress, WalletManagerOptions, WalletManagerConfig, WalletInterface, buildWalletManager } from 'wallet-monitor';
...
export const manager = new buildWalletManager(allChainWallets, options)
