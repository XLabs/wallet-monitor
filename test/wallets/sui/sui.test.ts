...
jest.mock("../../../src/balances/sui", () => ({
  pullSuiTokenBalances: jest.fn(() => [
    ...
    {
      coinType:
        "0xfded065d61215141ea7afac2e5c1a7b23514a91cbb2cfd86a38ed97e2f7871ac::PEPE::PEPE",
    ...
    switch (address) {
      ...
      case "0xd01cebc27fe22868df462f33603646549e13a4b279f5e900b99b9843680445e1::SHIBA::SHIBA":
        return {
          ...
          decimals: 9,
          address:
            "0xd01cebc27fe22868df462f33603646549e13a4b279f5e900b99b9843680445e1::SHIBA::SHIBA",
        };
    }
  }),
}));
...
describe("sui wallet tests", () => {
  ...
  test("Pull token balances", async () => {
    ...
    const wallet = createWalletToolbox("mainnet", "sui", wallets, options);
